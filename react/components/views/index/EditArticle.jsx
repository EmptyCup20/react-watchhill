    ...
    componentDidMount(){
        ...
        $.ajax({
            ...
            success:function(data){
                _this.refs.atricleTitle.value=data.data.title;
                _this.refs.atricleDescribe.value=data.data.describe;
                _this.refs.articleMd.clearMd(data.data.content);
                ...
                success:function(data){
                    ...
                    for(var url in data.data){
                        ...
                        '<li class="list-group-item" >'+
                            ...
                            '<a href="'+data.data[url]+'" class="url-view fa fa-fw fa-eye"  data-toggle="tooltip" data-placement="top" title="图片预览" data-lightbox="articleImg"></a>'+
                        '</li>';
                        node = node + str;
                    }
